...
<div id="content">
	<Table style="background-color: #E7CDFF; cellspacing:0; border:2px solid black; " class="jumbotron" >
  		 <TABLE style="cellspacing:1; " >
        
         <TR>
             <TD width="770" colspan='3' align="center" >
                 <Font color="#006600" size='5' face="標楷體">${AppName2}</Font>
             </TD>
         </TR>
         <TR>
             <TD width="270" ></TD>
             <TD width="230"  align="center">
                 <Font color="#006600" size='4' face="標楷體">增加員工</Font>
             </TD>
         ...
         <TR><TD colspan="3">
  <form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='register2.do' />"  id="register2.do" >
